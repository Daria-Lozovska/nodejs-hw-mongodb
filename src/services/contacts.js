...
import {paginationData} from "../filters/paginationData.js";
...
export const getContacts = async ({page = 1, perPage = 10, sortBy = '_id', sortOrder = sortList[0], filters = {}}) => {
    ...
    const calcPaginationData = paginationData({page, perPage, totalItems});

    return {
        data: items, page, perPage, totalItems, ...calcPaginationData,
    };
}
